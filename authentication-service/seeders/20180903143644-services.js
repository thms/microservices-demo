...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('services', [
      ...
      {id: 2, name: 'loan-factory-service', secret: 'loan-factory-secret', token: null, roles: JSON.stringify(['service']), scopes: JSON.stringify(['loan:write', 'loan:score', 'installment-plan:write', 'user:write'])},
